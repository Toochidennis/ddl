...
import com.digitaldream.ddl.Activities.CourseOutlines;
import com.digitaldream.ddl.Activities.TestUpload;
...
public class FlashCardTagsSettings extends BottomSheetDialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        GridLayout courseLayout = view.findViewById(R.id.course_container);
