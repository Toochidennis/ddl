...
public class AddClass extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for(int a=0;a<tchList.size();a++){
            teacherList.add(tchList.get(a).getStaffSurname()+ " "+tchList.get(a).getStaffFirstname());
        }
        ...
        formteacher.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        if (requestCode == 1) {
            if(resultCode == RESULT_OK) {
                ...
                try {
                    ...
                    String teacherName = teacherList.get(0).getStaffSurname()+" "+teacherList.get(0).getStaffFirstname();
    ...
    private void getAddClassApiCall(){
        ...
        String url = Login.urlBase+"/addClass.php?class_name="+classNameValue+"&level="+ClassResultFragment.levelId+"&form_teacher="+teacherId+"&_db="+db;
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if(status.equals("success")){
                        ...
                        dialog1.dismiss();
                        Toast.makeText(AddClass.this,"Class already added",Toast.LENGTH_SHORT).show();
                    }
    ...
    private void callEditClassApi(){
        ...
        String url = Login.urlBase+"/addClass.php?id="+classId+"&class_name="+classNameValue+"&level="+ClassResultFragment.levelId+"&form_teacher="+teacherId+"&_db="+db;
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                dialog1.dismiss();
                try {
                    ...
                    if(status.equals("success")){
                        ...
                        UpdateBuilder<ClassNameTable,Long> updateBuilder = classDao.updateBuilder();
                        ...
                        Toast.makeText(AddClass.this,"Class updated successfully",Toast.LENGTH_SHORT).show();
                        onBackPressed();
