...
import com.digitaldream.linkskool.Activities.ContentUpload;
import com.digitaldream.linkskool.Activities.Login;
import com.digitaldream.linkskool.Activities.TestUpload;
import com.digitaldream.linkskool.Adapters.OptionsAdapter;
...
public class QuestionDialog2 extends Dialog implements OptionsAdapter2.OnClickListener1 {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        applyBtn = findViewById(R.id.apply2);
        ...
        addOptionBtn = findViewById(R.id.add_opt);
        ...
        previewBtn = findViewById(R.id.previ);
        previewBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent1 = new Intent(getContext(), ExamActivity.class);
    ...
    private boolean validateDialog() {
        ...
        if (questionText!=null && questionText.getText().toString().isEmpty()) {
            ...
            Toast.makeText(getContext(), "Select atleast two correct answers "+count, Toast.LENGTH_SHORT).show();
            validate = false;
