...
import com.digitaldream.linkskool.Activities.AddNews;
...
import com.digitaldream.linkskool.Activities.ViewResult;
...
public class AdminDashbordFragment extends Fragment implements NewsAdapter.OnNewsClickListener, QAAdapter.OnQuestionClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        classesContainer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    public void onPause() {
        super.onPause();
        bundle = new Bundle();
       listState = qaRecycler.getLayoutManager().onSaveInstanceState();
