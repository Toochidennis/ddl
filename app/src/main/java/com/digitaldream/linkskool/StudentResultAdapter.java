...
public class StudentResultAdapter extends RecyclerView.Adapter<StudentResultAdapter.StudentResultViewHolder> {
    ...
    public StudentResultAdapter(Context context, List<StudentTable> studentResultList, OnStudentResultClickListener onStudentResultClickListener) {
    ...
    public void onBindViewHolder(@NonNull StudentResultViewHolder studentResultViewHolder, int i) {
        ...
        GradientDrawable gd = (GradientDrawable) studentResultViewHolder.counterBackground.getBackground().mutate();
    ...
    class StudentResultViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public StudentResultViewHolder(@NonNull View itemView, OnStudentResultClickListener onStudentResultClickListener) {
        super(itemView);
