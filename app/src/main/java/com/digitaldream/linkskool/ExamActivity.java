...
import com.digitaldream.linkskool.Adapters.QAdapter;
import com.digitaldream.linkskool.Models.QViewModel;
import com.digitaldream.linkskool.Utils.CustomDialog;
import com.digitaldream.linkskool.Utils.ImagePreviewDialog;
...
public class ExamActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button b = findViewById(R.id.myclick);
    ...
    private void renderQO(String[] arr,String correct1,LinearLayout q,TextView ans,LinearLayout a){
        ...
        try {
            ...
            for(int j=0;j<arr.length;j++) {
                ...
                if(!correct1.isEmpty()) {
                    String ct = correct1.substring(0,1);
                    Character cl1 = correct1.charAt(1);
