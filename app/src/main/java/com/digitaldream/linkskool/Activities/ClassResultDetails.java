...
import com.digitaldream.linkskool.Adapters.ClassTermsAdapter;
import com.digitaldream.linkskool.DatabaseHelper;
import com.digitaldream.linkskool.Models.ClassNameTable;
import com.digitaldream.linkskool.Models.ClassTermResulsModel;
...
public class ClassResultDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        classEdit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(ClassResultDetails.this, AddClass.class);
