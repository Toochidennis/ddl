...
public class StudentProfile extends AppCompatActivity {
    ...
    private List<String> guidanceInfoList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(st.getGuardianPhoneNo().isEmpty()) {
           call.setEnabled(false);
            callIcon.setColorFilter(ContextCompat.getColor(this, R.color.ligth_gray), android.graphics.PorterDuff.Mode.SRC_IN);
           sms.setEnabled(false);
            smsIcon.setColorFilter(ContextCompat.getColor(this, R.color.ligth_gray), android.graphics.PorterDuff.Mode.SRC_IN);
            whatsapp.setEnabled(false);
            whatsappIcon.setColorFilter(ContextCompat.getColor(this, R.color.ligth_gray), android.graphics.PorterDuff.Mode.SRC_IN);

        }

        if(st.getGuardianEmail().isEmpty()){
            email.setEnabled(false);
            emailIcon.setColorFilter(ContextCompat.getColor(this, R.color.ligth_gray), android.graphics.PorterDuff.Mode.SRC_IN);
        ...
        whatsapp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(!st.getGuardianPhoneNo().isEmpty()) {
                    Uri uri = Uri.parse("https://api.whatsapp.com/send?phone=" + "234" + st.getGuardianPhoneNo() + "&text=" + "");
        ...
        email.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(!st.getGuardianEmail().isEmpty()) {
                    ...
                    Uri data = Uri.parse("mailto:?subject=" + "subject text" + "&body=" + "body text " + "&to=" + st.getGuardianEmail());
                    emailIntent.setData(data);
                    startActivity(Intent.createChooser(emailIntent, "Send mail..."));
                }else{
                    Toast.makeText(StudentProfile.this,"email is not available",Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        viewResult.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(StudentProfile.this, StudentResultDownload.class);
        ...
        if(!st.getGuardianName().equals("") && !st.getGuardianName().equals("null")) {
            ...
            if (guardianName1.length() > 0) {
                guardianName1 = guardianName1.substring(0, 1).toUpperCase() + guardianName1.substring(1);
        ...
        if(!st.getGuardianAddress().equals("") && !st.getGuardianAddress().equals("null")) {
            ...
            guardianAddress1 = guardianAddress1.substring(0, 1).toUpperCase() + guardianAddress1.substring(1);
        ...
        if(!st.getGuardianEmail().isEmpty() && !st.getGuardianEmail().equals("null")) {
            ...
            guardianEmail = guardianEmail.substring(0,1).toUpperCase()+guardianEmail.substring(1);
        ...
        studentName.setText(st.getStudentSurname().toUpperCase()+" "+st.getStudentMiddlename().toUpperCase()+" "+st.getStudentFirstname().toUpperCase());
    ...
    private void deleteStudentApiCall(final String id){
        ...
        dialog1.show();
        String deleteUrl= Login.urlBase+"/delete.php?id="+id+"&_db="+db;
    ...
    protected void onResume() {
        ...
        if(!student.get(0).getGuardianAddress().equals("") && !student.get(0).getGuardianAddress().equals("null")) {
        ...
        if(!student.get(0).getGuardianPhoneNo().equals("") && !student.get(0).getGuardianPhoneNo().equals("null")) {
        ...
        if(!student.get(0).getGuardianEmail().isEmpty() && !student.get(0).getGuardianEmail().equals("null")) {
