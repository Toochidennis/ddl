...
import com.digitaldream.linkskool.Utils.ShareDialog;
...
import com.digitaldream.linkskool.Utils.ChooseActionDialog;
...
public class CourseOutlines extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addCourseOutline1.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        addCourseOutline2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ChooseActionDialog dialog = new ChooseActionDialog(CourseOutlines.this);
                dialog.setCancelable(true);
    ...
    protected void onResume() {
        ...
        tpList.clear();
        Collections.sort(courseOutlineList, new Comparator<CourseOutlineTable>(){
            @Override
            public int compare(CourseOutlineTable o1, CourseOutlineTable o2) {
            ...
            itemHolder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    context.startActivity(intent);
                        ...
                        Log.i("json", childList.get(position).getCourseName().toString());
                        Toast.makeText(layout.getContext(),
                                courseOutlineList.get(position).getCourseName().toString(),
                ...
                public void onResponse(String response) {
                    ...
                    if(status.equalsIgnoreCase("success")) {
                        ...
                        Collections.sort(courseOutlineList, new Comparator<CourseOutlineTable>(){
                            @Override
                            public int compare(CourseOutlineTable o1, CourseOutlineTable o2) {
                                return o1.getWeek().compareToIgnoreCase(o2.getWeek());
                            }
                        });
                        adapter.removeAllSections();
