...
public class StudentContactAdapter extends RecyclerView.Adapter<StudentContactAdapter.ContactViewHolder>  {
    ...
    public StudentContactAdapter(Context context, List<StudentTable> studentContactList, OnStudentContactClickListener onStudentContactClickListener) {
    ...
    public void onBindViewHolder(@NonNull final ContactViewHolder contactViewHolder, int i) {
        ...
        String studentName = st.getStudentSurname()+" "+st.getStudentMiddlename()+" "+st.getStudentFirstname();
        GradientDrawable gd = (GradientDrawable) contactViewHolder.counterBackground.getBackground().mutate();
        ...
        if(flagValue){
            selectAll();
            contactViewHolder.cardView.setBackgroundColor(st.isSelected()?Color.GRAY : Color.WHITE);
        ...
        contactViewHolder.cardView.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                ...
                contactViewHolder.cardView.setBackgroundColor(st.isSelected()?Color.parseColor("#ECECEC") : Color.WHITE);
                if(st.isSelected()){
        ...
        contactViewHolder.callButton.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        contactViewHolder.smsButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
    ...
    class ContactViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        private TextView name,itemCounter;
        private ImageView callButton,smsButton;
        CardView cardView;
        private LinearLayout counterBackground;
        OnStudentContactClickListener onStudentContactClickListener;

        public ContactViewHolder(@NonNull View itemView, OnStudentContactClickListener onStudentContactClickListener) {
            super(itemView);
    ...
    public interface OnStudentContactLongClickListener{
        void onStudentContactLongClick(int position);
    }
